...
//Interval in which recurring chat (bot) messages are send out - 9 minutes (630000MS)
#define COMMANDS_INTERVAL 630000
...
class TwitchIRC {
     ...
     private:
         ...
         //Thread instance which runs the streamUpdates command
